...
So, `r length(amp_yaw_columns)` more columns are removed. `r ncol(training_redux)` remain from the original `r ncol(training)`, and, as it has been mentioned, some of them are not relevant for the analysis.
