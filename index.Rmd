...
```{r pcamodel, echo=FALSE, cache=TRUE, results='hide'}
...
From the results of the different models, we can see that the random forest model has the lowest OOB estimate of error rate (see final model OOB estimate of error rate above, as well as the confusion matrix). Thus, this is the model we will select for our analysis (and this also servers as cross-validation).
